...
public class DataPlayer extends javax.swing.JFrame {
    
    public Player01 player01 = new Player01("Player", 100, 10, 15, 20, 30);
    ...
    public DataPlayer() {
        ...
        enemyLife.setText(Double.toString(player01.getLife()));
        enemyPowerAttack.setText(Double.toString(player01.getPowerAttack()));
        enemyLowerAttack.setText(Double.toString(player01.getLowerAttack()));
        enemyRangedAttack.setText(Double.toString(player01.getRangedAttack()));
        enemyBaseAttack.setText(Double.toString(player01.getBaseAttack()));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Story/Data/DataYou.png"))); // NOI18N
