...
public class BattleSocram extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        youBaseAttack.setBounds(330, 230, 230, 16);
        ...
        youRangedAttack.setBounds(420, 300, 150, 16);
        ...
        youLife.setBounds(330, 190, 220, 16);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ((socram.getLife() <= 0) || (socram.getLife() <= 0 && player.getLife() <= 0)) {
            socram.setlife(100);
            player.setlife(100);

            VictorySocram victorySocram = new VictorySocram();
            this.dispose();
            victorySocram.setVisible(true);
        } else if (socram.getLife() > 0 && player.getLife() <= 0) {
            socram.setlife(100);
            player.setlife(100);

            DefeatSocram defeatSocram = new DefeatSocram();
            this.dispose();
            defeatSocram.setVisible(true);
        }
