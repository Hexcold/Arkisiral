...
import view.battle.victory.VictorySenrub;
...
public class BattleSenrub extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        youLife.setBounds(330, 190, 240, 16);
        ...
        enemyLowerAttack.setBounds(780, 270, 200, 16);
        ...
        enemyRangedAttack.setBounds(760, 300, 220, 16);
        ...
        enemyLife.setBounds(670, 190, 170, 16);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ((senrub.getLife() <= 0) || (senrub.getLife() <= 0 && player.getLife() <= 0)) {
            senrub.setlife(100);
            player.setlife(100);
