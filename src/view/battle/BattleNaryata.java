...
import view.battle.victory.VictoryNaryata;
...
public class BattleNaryata extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ((naryata.getLife() <= 0) || (naryata.getLife() <= 0 && player.getLife() <= 0)) {
            naryata.setlife(100);
            player.setlife(100);

            VictoryNaryata victoryNaryata = new VictoryNaryata();
            this.dispose();
            victoryNaryata.setVisible(true);
        } else if (naryata.getLife() > 0 && player.getLife() <= 0) {
            naryata.setlife(100);
            player.setlife(100);

            DefeatNaryata defeatNaryata = new DefeatNaryata();
            this.dispose();
            defeatNaryata.setVisible(true);
        }
